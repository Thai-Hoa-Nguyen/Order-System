...
-----------------------------------------------------------
Function:
- Display menu and get selection -> void Ordering::orderFood() (Learn how to dynamic copy in cpp)
Source:
...
namespace seneca
{
    ...
    {
        // Create menu with food items - note the title is "Food Menu" and "Back to Order" for exit
        ...
        if (selection != 0)
        {
            ...
            // Customize the order with second menu that's also called "Food Size Selection"
            if (food->order())
            {
    ...
    {
        // Create menu with drink items - using "Drink Menu" as the title and "Back to Order" for exit
