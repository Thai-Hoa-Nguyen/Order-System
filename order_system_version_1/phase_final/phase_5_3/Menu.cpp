...
namespace seneca
{
    ...
    void Menu::displaySubTitle() const
    {
        if (title.menuItemContent != nullptr)
        {
            // Use indentation based on the menu's level
            if (indentNumber == 1) {
                // Level 1 - indented by 3 spaces for Order Menu
                cout << "   " << title.menuItemContent << endl;
            }
            else if (indentNumber == 2) {
                // Level 2 - indented by 6 spaces for Drink and Food Menu
                cout << "      " << title.menuItemContent << endl;
            }
            else if (indentNumber == 3) {
                // Level 3 - indented by 9 spaces for Size Selection menus
                cout << "         " << title.menuItemContent << endl;
            }
            else {
                // Default case - use calculated indentation
                for (unsigned int i = 0; i < indentNumber * indentSize; i++) {
                    cout << " ";
                }
                cout << title.menuItemContent << endl;
