...
/*---------------------------------------------------------- -
FoolProof entry:
- Trim function to removes leading and trailing whitespace
Source: https://cplusplus.com/forum/beginner/863/

- Function to read and validate an integer input (Utils::getInt() const)
Source:
+ https://cplusplus.com/reference/string/stoi/ -- using stoi for converting a string to an integer

+ https://www.w3schools.com/cpp/cpp_exceptions.asp
  using try and catch blocks are employed to handle exceptions that may arise during
  the conversion of a string to an integer using std::stoi

- Using library <stdexcept>
